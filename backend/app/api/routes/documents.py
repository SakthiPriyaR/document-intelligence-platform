...
async def process_document_endpoint(
    ...
    # Image uploads use Gemini vision and complete in-request. Keeping this
    # path synchronous ensures the final record is persisted before Render's
    # free web process can recycle; in-process background jobs are disposable.
